...
private:
	...
	void allocateBuffer();
	void freeBuffer();
	void setInputData(const png::image<png::rgb_pixel>& leftImage, const png::image<png::rgb_pixel>& rightImage, std::string &tempOutPutFileName);
	void setLabImage(const png::image<png::rgb_pixel>& leftImage);
	void computeInitialDisparityImage(const png::image<png::rgb_pixel>& leftImage, const png::image<png::rgb_pixel>& rightImage, std::string &tempOutPutFileName);
	void initializeSegment(const int superpixelTotal,  unsigned int *lableSEED);
	void makeGridSegment(const int superpixelTotal,  unsigned int *lableSEED);
	void assignLabel();
