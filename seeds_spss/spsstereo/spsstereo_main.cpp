...
int main(int argc, char* argv[]) {
	...
	std::vector< std::vector<int> > boundaryLabels;
	int superpixelTotal = 500;
	sps.compute(superpixelTotal, leftImage, rightImage, segmentImage, disparityImage, disparityPlaneParameters, boundaryLabels, tempOutputDisparityImageFilename);
